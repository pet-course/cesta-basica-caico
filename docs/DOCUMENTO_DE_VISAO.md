...
--------- | ------------------------------------------------ | ---------- |
RFA01     | Cadastrar no sistema                             | Aluno      |
RFA02     | Cadastrar nova marca do produto                  | Aluno      |
RFA03     | Cadastrar os preços dos produtos                 | Aluno      |
RFA04     | Realizar Pesquisa                                | Aluno      |
RFA05     | Buscar suas pesquisas anteriores                 | Aluno      |
RFP01     | Cadastrar no sistema                             | Professor  |
RFP02     | Verificar solicitações de login                  | Professor  |
RFP03     | Cadastrar Produto                                | Professor  |
RFP04     | Cadastrar supermercados aptos para a pesquisa    | Professor  |
RFP05     | Realizar pesquisa                                | Professor  |
RFP06     | Cadastrar nova marca do produto                  | Professor  |
RFP07     | Realizar a busca de pesquisas anteriores         | Professor  |
RFP08     | Realizar a busca de alunos                       | Professor  |
RFP09     | Compartilhar planilha                            | Professor  |
RFSY01    | Gerar planilha com os dados de cada supermercado | Sistema    |
RFSY02    | Gerar Relatórios                                 | Sistema    |
RFSY03    | Gerar logs de ações                              | Sistema    |
